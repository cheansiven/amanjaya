...
<div class="on-web">
    <footer id="hl_content" class="above-footer wrap-gallery" role="contentinfo">
        <div id="gallery-albums" class="container">
            <!--Juinior Suite-->
            <figure class="gallery-items" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                <a href="<?php echo base_url('public/images/gallery/room-suite/juinior-suites-bathroom-2.jpg') ?>" itemprop="contentUrl" data-size="2600x1920">
                    <img src="<?php echo base_url('public/images/gallery/room-suite/thumb/juinior-suites-bathroom-2-thb.jpg') ?>" itemprop="thumbnail" alt="Image description" />
                </a>
