...
<div>
    ...
    <div
        ...
        <div style=" font-weight: 600; text-transform: capitalize; padding-bottom: 40px;">
            Dear
            <span><?php echo $booking->row('name_of_reservation'); ?></span>
        </div>

        <div style="padding-bottom: 10px">
            <p style="line-height: 20px;">We have well received your booking for : </p>

            <p style="line-height: 20px;">
                <span class="red-darker text-capitalize"
                      style="color: #88001b;"><?php echo $booking->row('number_of_guests'); ?></span>
                <span> guest(s)</span>
            </p>
        </div>

        <div style="padding-bottom: 10px">
            <p style="line-height: 20px;">on the</p>
            <p style="line-height: 20px;">
	...
	"/>
        ...
        <div style="font-size: 14px !important; text-transform: uppercase;">
            <p style="font-size: 16px !important; padding: 30px; font-weight: 600; line-height: 20px;">amanjaya suites
                hotel</p>
            <div class="section" style="padding-bottom: 10px; font-size: 14px !important; text-transform: uppercase;">
                <p style="line-height: 20px;">#1 street 154</p>
                <p style="line-height: 20px;">[ corner with sisovath quay ]</p>
                <p style="line-height: 20px;">phnom penh kingdom of cambodia </p>
            </div>
            <p style="line-height: 20px;">T +855 (0) 23 21 47 47 </p>
            <p style="line-height: 20px;">F +855 (0) 23 21 95 45 </p>
        </div>
    </div>
